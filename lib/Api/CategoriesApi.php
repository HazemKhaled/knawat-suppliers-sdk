...
class CategoriesApi
{
    ...
    /**
     * Operation catalogCategoriesGet
     *
     * Get list of categories
     *
     * @param  float $parent_id parent_id (optional)
     * @param  float $level level (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse2005
     */
    public function catalogCategoriesGet($parent_id = null, $level = null)
    {
        list($response) = $this->catalogCategoriesGetWithHttpInfo($parent_id, $level);
        return $response;
    }

    /**
     * Operation catalogCategoriesGetWithHttpInfo
     *
     * Get list of categories
     *
     * @param  float $parent_id (optional)
     * @param  float $level (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse2005, HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogCategoriesGetWithHttpInfo($parent_id = null, $level = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->catalogCategoriesGetRequest($parent_id, $level);
    ...
    /**
     * Operation catalogCategoriesGetAsync
     *
     * Get list of categories
     *
     * @param  float $parent_id (optional)
     ...
     */
    public function catalogCategoriesGetAsync($parent_id = null, $level = null)
    {
        return $this->catalogCategoriesGetAsyncWithHttpInfo($parent_id, $level)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation catalogCategoriesGetAsyncWithHttpInfo
     *
     * Get list of categories
     *
     * @param  float $parent_id (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogCategoriesGetAsyncWithHttpInfo($parent_id = null, $level = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->catalogCategoriesGetRequest($parent_id, $level);
    ...
    /**
     * Create request for operation 'catalogCategoriesGet'
     *
     * @param  float $parent_id (optional)
     * @param  float $level (optional)
     *
     ...
     */
    protected function catalogCategoriesGetRequest($parent_id = null, $level = null)
    {
