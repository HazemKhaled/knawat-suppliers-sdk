...
class ImportFile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Import_file';
...
'status' => 'getStatus'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['supplier_key'] = isset($data['supplier_key']) ? $data['supplier_key'] : null;
     ...
     * Sets created
     *
     * @param \DateTime $created The date the file was imported
     *
     * @return $this
     */
    ...
    {
        return $this->container['supplier_key'];
    }

    /**
     * Sets supplier_key
     *
     * @param string $supplier_key key for supplier
     *
     * @return $this
     */
    public function setSupplierKey($supplier_key)
    {
        $this->container['supplier_key'] = $supplier_key;
     ...
     * Sets file_url
     *
     * @param string $file_url location url of file
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status status can be in-progress/queued/parsed
     *
     * @return $this
     */
